...
int MainScreen::drawBackground()
{
	...
	imageBack = al_load_bitmap("figuras/background.jpg");
	if (imageBack == NULL)
		return -1;
...
int MainScreen::drawButtons()
{
	...
	imageButtonBuy = al_load_bitmap("figuras/botao_compra.png");
	...
	imageButtonCert = al_load_bitmap("figuras/botao_certifica.png");
...
int MainScreen::drawLegendArrow()
{
	...
	imageLegend = al_load_bitmap("figuras/legenda.png");
	if (imageLegend == NULL)
		return -1;
	...
	imageArrow = al_load_bitmap("figuras/seta.png");
	if (imageArrow == NULL)
		return -1;
...
int MainScreen::drawRoullete(float angle)
{
	if (imageRoullete == NULL)
		imageRoullete = al_load_bitmap("figuras/roleta.png");
	if (imageRoullete == NULL)
		return -1;
...
int MainScreen::drawRounds(int roundNumber, int totalRounds)
{
	...
	fontRounds = al_load_ttf_font("DejaVuSans.ttf", 30, 0);
	if (fontRounds == NULL)
	{
